...
const App = () => {
  ...
  const CONTRACT_ADDRESS = "0xa12fa38716a20FA7bA6716c63d96e11bd32464BF";
  let supply, price;
  ...
  const askContractToMintNft = async () => {
    ...
    try {
      ...
      if (ethereum) {
        ...
        supply = await connectedContract.getCurrentSupply();
        console.log("This is supply", supply.toNumber())
        price = await connectedContract.getPrice();
        console.log("This is price", ethers.utils.formatEther(price))
        let nftTxn = await connectedContract.makeAnEpicNFT({value: ethers.utils.parseEther(ethers.utils.formatEther(price)), gasLimit: 10000000});
